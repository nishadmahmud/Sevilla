...
export default function ProductSidebar() {
    ...
    const warranties = [
        { id: 1, title: "sevilla Care+ 1 Year", desc: "Brand New Parts Guarantee", price: "BDT 5,100" },
        { id: 2, title: "sevilla Motor Care+ : 5 Years", desc: "Free motor replacement (excluding physical damage)", price: "BDT 6,120" },
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden mt-4 shadow-sm">
                ...
                <div className="bg-gray-50 px-4 py-3 border-t border-gray-100 flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-600 font-medium tracking-wide">I agree to sevilla's <span className="underline cursor-pointer">terms & conditions</span></span>
                </div>
            </div>
        </div>
    );

...
export const metadata = {
    title: "Privacy Policy | sevilla",
    description: "sevilla privacy policy — how we collect, use, and protect your personal information.",
};
...
const sections = [
    ...
    },
    {
        ...
        content: [
            ...
            "You may request a copy of the data we hold about you by contacting us at support@sevilla.com.bd.",
        ],
    },
    {
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-8 -mt-6">
                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10">
                    <p className="text-sm text-gray-600 leading-relaxed mb-8">
                        At sevilla, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or make a purchase.
                    </p>
                    ...
                    <div className="mt-10 p-5 bg-gray-50 rounded-xl border border-gray-100">
                        <p className="text-sm text-gray-600">
                            ...
                            <a href="mailto:support@sevilla.com.bd" className="text-brand-red font-semibold hover:underline">support@sevilla.com.bd</a> or call{" "}
